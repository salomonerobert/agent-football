...
# =====================================================================
# Task 4 & 5: Defender Specialist Agent (DefenderSpecialist) - TEMPLATE
# =====================================================================
...
# 1. Initialize `defender_agent` as an LlmAgent.
# 2. Set name="DefenderSpecialist" and model=GeminiConstants.GEMINI_FLASH_LITE.
# 3. Equip it with `update_profile` in the `tools` list.
# 4. Write the system instruction prompt.
#
# Available Defender Attributes (to modify via update_profile):
...
defender_agent = None  # 👈 REPLACE THIS WITH YOUR LlmAgent INITIALIZATION IN TASK 4
